...
%class4_train = dlmread('../Dataset_Assignment1/Dataset-1_2Dimensional/non-linearly_Separable/group19/class4_train.txt');
...
%class4_val = dlmread('../Dataset_Assignment1/Dataset-1_2Dimensional/non-linearly_Separable/group19/class4_val.txt');
...
a.testData = [class1_val; class2_val; class3_val];
...
title(' Non-linearly seperable data using KNN');
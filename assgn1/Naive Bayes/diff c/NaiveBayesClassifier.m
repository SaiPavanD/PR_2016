classdef NaiveBayesClassifier
    ...
    methods
        function class = classify4(obj,test)
            ...
            c1 = diag(diag(cov(obj.train1)));
            c2 = diag(diag(cov(obj.train2)));
            c3 = diag(diag(cov(obj.train3)));
            c4 = diag(diag(cov(obj.train4)));
            
            l1=mvnpdf(test,m1,c1);
            l2=mvnpdf(test,m2,c2);
            l3=mvnpdf(test,m3,c3);
            l4=mvnpdf(test,m4,c4);
